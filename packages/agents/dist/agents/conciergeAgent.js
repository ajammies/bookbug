...
// collects story specs, and hands over a clean StoryIntake to downstream agents.
...
export class ConciergeAgent {
    ...
    extractionAgent;
    log;
    constructor({ model = AgentConfig.model('concierge'), log = defaultLogger } = {}) {
        this.log = log;
...
function buildIntakeConversationInstructions() {
    const schemaDescription = JSON.stringify(StoryIntakeSchema.shape, null, 2);
...
//# sourceMappingURL=conciergeAgent.js.map